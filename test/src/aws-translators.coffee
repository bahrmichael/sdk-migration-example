...
describe 'aws-translators', () ->
  ...
  describe '#deleteItem', () ->
    ...
    it 'should call deleteItem of aws with extra params', () ->
      ...
      expect(dynastyTable.parent.dynamo.deleteItem.calledOnce)
      expect(dynastyTable.parent.dynamo.deleteItem.getCall(0).args[0]).to.include.keys('ReturnValues')
  ...
  describe '#getItem', () ->
    ...
    it 'should call getItem of aws with extra params', () ->
      ...
      expect(dynastyTable.parent.dynamo.getItem.calledOnce)
      expect(dynastyTable.parent.dynamo.getItem.getCall(0).args[0].TableName).to.equal(dynastyTable.name)
      expect(dynastyTable.parent.dynamo.getItem.getCall(0).args[0].ProjectionExpression).to.equal('id, name')
  ...
  describe '#scan', () ->
    ...
    it 'should call scan of aws with extra params', () ->
      ...
      expect(dynastyTable.parent.dynamo.scan.calledOnce)
      expect(dynastyTable.parent.dynamo.scan.getCall(0).args[0].TableName).to.equal(dynastyTable.name)
      expect(dynastyTable.parent.dynamo.scan.getCall(0).args[0].ReturnConsumedCapacity).to.equal('NONE')
  ...
  describe '#query', () ->
    ...
    it 'should call query', () ->
      ...
      expect(dynastyTable.parent.dynamo.query.calledOnce)
      expect(dynastyTable.parent.dynamo.query.getCall(0).args[0]).to.include.keys('TableName', 'IndexName', 'KeyConditions')
  ...
  describe '#putItem', () ->
    ...
    it 'should add extra params from options', () ->
      ...
      expect(dynastyTable.parent.dynamo.putItem.calledOnce)
      expect(dynastyTable.parent.dynamo.putItem.getCall(0).args[0]).to.include.keys('Item', 'TableName', 'ReturnValues')
  ...
  describe '#updateItem', () ->
    ...
    it 'should automatically setup ExpressionAttributeNames mapping', () ->
      sandbox.spy(dynastyTable.parent.dynamo, "updateItem")
      promise = lib.updateItem.call(dynastyTable, {}, foo: 'bar', null, null,
        hashKeyName: 'bar'
        hashKeyType: 'S'
      )
      expect(dynastyTable.parent.dynamo.updateItem.calledOnce)
      params = dynastyTable.parent.dynamo.updateItem.getCall(0).args[0]
