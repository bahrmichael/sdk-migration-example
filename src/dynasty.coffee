...
{ DynamoDBClient, UpdateTableCommand, CreateTableCommand, DeleteTableCommand, ListTablesCommand, DescribeTableCommand } = require('@aws-sdk/client-dynamodb')
_ = require('lodash')
  ...
  constructor: (credentials, url) ->
    ...
    if credentials.accessKeyId or credentials.secretAccessKey
      ...
      if credentials.accessKeyId
        config.credentials.accessKeyId = credentials.accessKeyId
      else if process.env.AWS_ACCESS_KEY_ID
        config.credentials.accessKeyId = process.env.AWS_ACCESS_KEY_ID

      if credentials.secretAccessKey
        config.credentials.secretAccessKey = credentials.secretAccessKey
